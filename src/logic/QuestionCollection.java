...
public class QuestionCollection {
	...
	public QuestionCollection() {
		...
		Questions.add(new Question("la recta u es el eje de simetría axial entre los dos triángulos.", false, "antitraslacion.png"));
		...
		Questions.add(new Question("En la siguiente imágen, sabemos que el cuadrado rojo es imágen del cuadrado azul con la recta r como eje de simetría axial.¿Podemos tambien decir que existe simetría central entre ambos cuadrados, con el punto O como centro de simetría?", false, "preguntaCuadrados.png"));
		
		Questions.add(new Question("Sabemos que A'B'C'D' es imágen de ABCD con el punto E como centro de simetría.¿Podemos decir que  el segmento BC' es paralelo al segmento CB'?", true, "preguntaCentral.png"));
		
		Questions.add(new Question("En la siguiente imágen, sabemos que A'B'C' es la imágen de trasladar ABC por el vector u.\\n¿Podemos también decir que existe algún tipo de simetría entre ABC y A'B'C?", true, "preguntaTraslacion.png"));
